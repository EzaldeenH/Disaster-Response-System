...
namespace Disaster_Response_System.Migrations
{
    ...
    [Migration("20240920025758_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Disaster_Response_System.Models.AffectedIndividual", b =>
                {
                    b.HasOne("Disaster_Response_System.Models.Request", "Request")
                        .WithOne("AffectedIndividuals")
                        .HasForeignKey("Disaster_Response_System.Models.AffectedIndividual", "RequestID")
            ...
            modelBuilder.Entity("Disaster_Response_System.Models.Donation", b =>
                {
                    b.HasOne("Disaster_Response_System.Models.Donor", "Donor")
                        .WithOne("Donations")
                        .HasForeignKey("Disaster_Response_System.Models.Donation", "DonorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Disaster_Response_System.Models.RequestEvaluation", b =>
                {
                    b.HasOne("Disaster_Response_System.Models.Request", "Request")
                        .WithOne("RequestEvaluations")
                        .HasForeignKey("Disaster_Response_System.Models.RequestEvaluation", "RequestID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Disaster_Response_System.Models.RequestItem", b =>
                {
                    b.HasOne("Disaster_Response_System.Models.Request", "Request")
                        .WithOne("RequestItems")
                        .HasForeignKey("Disaster_Response_System.Models.RequestItem", "RequestID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
